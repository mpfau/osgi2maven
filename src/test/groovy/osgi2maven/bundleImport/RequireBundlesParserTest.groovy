...
class RequireBundlesParserTest {
    ...
    @Test
    public void testGetBundlesMissingQuote() {
        def bundles = new RequireBundlesParser('org.eclipse.equinox.common;bundle-version="[3.2.0,4.0.0)').getRequireBundles()
        assertEquals("The required string contains one bundle", 1, bundles.size())
        assertEquals bundles[0].toString(), "name: org.eclipse.equinox.common; version: [3.2.0,4.0.0); visibility: private; resolution: mandatory"
    }
